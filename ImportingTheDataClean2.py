...
class Data:
    ...
    def counting(self):
        ...
        """
        max_force_columns = min_force_columns = []
        ...
        force_ranges = []
        outer_range = max_force - min_force  # TODO: Check of dit geen problemen geeft als min_force een - getal is.
        for i in range(int(round(outer_range/10, 0))):
